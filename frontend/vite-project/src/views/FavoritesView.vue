...
<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-sans">
    ...
    <div class="flex items-center text-xs text-gray-500 gap-1.5 uppercase font-medium tracking-wide mb-8">
      ...
      <span>/</span>
      <router-link to="/profile" class="hover:text-secondary transition-colors">Portal</router-link>
      <span>/</span>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2 bg-white border border-gray-100 p-6 sm:p-8 rounded-lg shadow-sm text-left">
        <div class="flex justify-between items-center border-b border-gray-100 pb-4 mb-6">
          ...
          <button 
            @click="fetchWishlist" 
            class="text-xs font-semibold text-secondary hover:underline bg-transparent border-0 cursor-pointer outline-none"
          >
            Refresh Wishlist
          </button>
        </div>
        ...
        <div v-else-if="wishlist.length === 0" class="py-16 text-center">
          ...
          <router-link 
            to="/shop" 
            class="inline-block bg-secondary text-white font-bold text-xs tracking-wide py-3 px-6 rounded-md shadow-sm hover:opacity-95 mt-6 transition-all"
          >
            Explore Shop
          </router-link>
        </div>
          ...
          >
            ...
            <div class="p-4 text-left flex-grow flex flex-col justify-between">
              <div>
                ...
                <router-link :to="`/products/${prod._id}`" class="block font-bold text-gray-800 text-sm hover:text-secondary transition-colors mt-0.5 truncate">
              ...
              <div class="mt-4 flex gap-2 pt-2 border-t border-gray-50">
                ...
                <button 
                  ...
                  class="flex-1 bg-secondary text-white font-bold text-[11px] tracking-wide py-2 px-3 rounded flex items-center justify-center gap-1.5 shadow-sm hover:opacity-95 active:scale-[0.99] transition-all cursor-pointer"
                >
