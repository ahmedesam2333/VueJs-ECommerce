  ...
  <div class="text-left font-sans">
    ...
    <div class="border border-gray-100 p-8 bg-white space-y-6">
      ...
      <div class="flex justify-between items-center pb-4 border-b border-gray-100 text-sm">
        ...
        <span class="text-secondary font-semibold">${{ subtotal.toFixed(2) }}</span>
      </div>
      ...
      <div class="flex justify-between items-center pb-6 border-b border-gray-100 text-sm">
        ...
        <span class="text-secondary font-bold text-lg">${{ total.toFixed(2) }}</span>
      </div>
      ...
      <div class="pt-4">
        <button
          ...
          :disabled="loading"
          class="w-full md:w-auto bg-secondary hover:bg-secondary/90 text-white font-semibold text-xs tracking-widest uppercase py-4 px-8 rounded-none transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
        >
