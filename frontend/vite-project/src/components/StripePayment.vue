    ...
    <div :class="{ 'hidden': loadingStripe }">
      ...
      <div class="flex flex-col sm:flex-row items-center gap-4 justify-between pt-4">
        ...
        <button
          ...
          class="w-full sm:w-auto bg-secondary hover:bg-secondary/90 text-white font-semibold text-xs tracking-widest uppercase py-4 px-8 rounded-none transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
        >
